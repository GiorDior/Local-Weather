...
// Value is returned in kelvin, need to convert to F
...
//convert wind speed to imperial units
...
// access api using key
function forcast(citySearch) {
  city = citySearch;
  const url = `https://api.openweathermap.org/data/2.5/forecast?q=${citySearch}&appid=fa84ade08b3d1f251a3fa29023dea053`;
  fetch(url)
